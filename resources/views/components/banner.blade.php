<div class="z-50 fixed bottom-0 inset-x-0 pb-2 sm:pb-5" x-data="{ show: true, hide() { window.localStorage.show_launch_banner = 'hide'; this.show = false } }" x-init="
    show = window.localStorage.show_launch_banner !== 'hide'
    " x-show="show">
        ...
        <div class="p-2 rounded-lg bg-yellow-600 shadow-lg sm:p-3">
            <div class="flex items-center justify-between flex-wrap">
                ...
                <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
                    <a href="https://airtable.com/shr7ymH15hGamMlcY"  class="w-full inline-flex space-x-2 justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium hover:bg-gray-50">
