        ...
        <div class="p-2 rounded-lg bg-gradient-to-br from-yellow-300 to-pink-400 mix-blend-multiply shadow-lg sm:p-3">
            <div class="flex items-center justify-between flex-wrap">
                ...
                <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
                    <a href="https://airtable.com/shr7ymH15hGamMlcY" data-splitbee-event="Click banner CTA" class="w-full inline-flex space-x-2 justify-center py-2 px-4 rounded-md bg-white text-sm font-medium hover:bg-gray-50">
